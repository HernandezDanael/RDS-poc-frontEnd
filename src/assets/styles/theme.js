const getDefaultThemeAbstarct = (variables) => {
    ...
    return {
      ...
      agGridCustom: {
        ...
        gridStyles: {
          ...
          '--ag-modal-overlay-background-color': variables.palette.background.default,
          ...
          '--ag-control-panel-background-color': variables.palette.background.default,
          ...
          '--ag-range-selection-background-color': variables.palette.background.default,
          '--ag-range-selection-background-color-2': variables.palette.background.default,
          '--ag-range-selection-background-color-3': variables.palette.background.default,
          '--ag-range-selection-background-color-4': variables.palette.background.default,
          ...
          '--ag-input-disabled-background-color': variables.palette.background.default,
          '--ag-line-height': '31px',
  ...
  const getDefaultVariableThemeWhite = () => {
    return {
      ...
      palette: {
        mode: 'light',
        boxShadow: {
          default: '0px 3px 1px -2px rgb(0 0 0 / 20%), 0px 2px 2px 0px rgb(0 0 0 / 14%), 0px 1px 5px 0px rgb(0 0 0 / 12%)',
        },
        primary: {
          main: '#006689',
        },
  ...
  export const defaultThemeWhite = getDefaultThemeWhite(getDefaultVariableThemeWhite());
