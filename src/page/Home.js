  ...
  return (
    <BrowserRouter>
      <div className="containerApp" style={{ height: window.innerHeight }}>
        <div className="window" style={{ backgroundColor: theme.palette.background.main, padding: '0', height: window.innerHeight}}>
          <Headers setIsChangeTheme={setIsChangeTheme}></Headers>
          <div style={{ width: '100%', display: 'flex', height: 'calc(100% - 112px)' }}>
          <Menu></Menu>
            <div style={{width: '100%'}}>
              <Routes>
